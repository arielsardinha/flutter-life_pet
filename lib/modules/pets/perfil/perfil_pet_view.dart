...
class PerfilPetView extends StatelessWidget {
  PerfilPetView({Key? key}) : super(key: key);
  final controller = PerfilPetController();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ListView(
                        ...
                        children: [
                          cardItens(
                              label: 'Idade', value: pet.idade.toString()),
      ...
      bottomNavigationBar: CustonAppBar(petId: petId, paginaAberta: 0),
    );
  }
}
